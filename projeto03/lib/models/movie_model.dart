class Movie {
  ...
  late final int page;
  late final List<Movies> moviesList;
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['page'] = page;
    _data['results'] = moviesList.map((e) => e.toJson()).toList();
  ...
  @override
  String toString() {
    return 'Movie(posterPath: $posterPath, id: $id, backdropPath: $backdropPath, totalResults: $totalResults, public: $public, revenue: $revenue, page: $page, results: $moviesList, iso_639_1: $iso_639_1, totalPages: $totalPages, description: $description, averageRating: $averageRating, runtime: $runtime, name: $name)';
  }
  ...
  Movie copyWith({
    ...
    return Movie(
      ...
      page: page ?? this.page,
      moviesList: results ?? this.moviesList,
